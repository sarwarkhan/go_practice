//https://godoc.org/github.com/sigurn/crc16
...
func main() {
	...
	//crc := Checksum([]byte{0D, 0x01, 0x01, 0x23, 0x45, 0x67, 0x89, 0x01, 0x23, 0x45, 0x00, 0x01}, table)
	//crc := Checksum([]byte{05, 01, 00, 01}, table)
	b, _ := hex.DecodeString("0D0101234567890123450001")
	//b, _ := hex.DecodeString("05010001")
	fmt.Println(b)
